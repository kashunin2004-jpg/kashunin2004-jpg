[![Header](https://github.com/kashunin2004-jpg/kashunin2004-jpg/blob/main/assets/cash.jpg)](https://vk.com/cashunin)

# 👋 Hi, I’m QA Engineer (Junior)
Меня зовут Кашунин Евгений и я начинающий QA Engineer с сильной теоретической базой и практическими навыками ручного тестирования веб- и мобильных приложений. Прошёл профессиональное обучение по тестированию ПО, уверенно работаю с тестовой документацией, API и инструментами баг-трекинга. Интересуюсь качеством продукта и логикой пользовательского поведения.
## 🔍 What I do as a QA
Анализирую требования и нахожу несоответствия
Тестирую функциональность веб и мобильных приложений (Android / iOS)
Создаю test cases, checklists, bug reports
Провожу smoke, regression и exploratory testing
Тестирую REST / SOAP API
## 🛠 Tools & Technologies
...
- Примеры [test cases](vk.com) и [checklists]()
- Примеры [bug reports]()
- Небольшие учебные проекты
- Эксперименты с API-тестированием
## 🎓 Education
### Northern Arctic Federal University
Bachelor’s degree | <b>Intelligent Systems in the Humanitarian Field</b> | 4th year
## 🎓 Certificate
[![QA Certificate](assets/file-001.png)](assets/stepik-certificate-171826-1d1863a.pdf)
## 🎶 A bit about me
До недавнего времени не представлял, что научну погружаться в IT сферу. Совсем недавно я активно занимался музыкой. Этот опыт научил меня дисциплине, внимательности к деталям и умению доводить работу до результата. Сейчас переношу этот подход в сферу обеспечения качества ПО и развития в IT.
## 📄 Resume (PDF)
[![QA Resume](assets/resume.png)](assets/resume.pdf)
## 🌱 Currently learning
- Углубление знаний в тестировании API
- Автоматизация тестирования (первые шаги)
- Улучшение английского для работы с документацией
### Социальные сети
